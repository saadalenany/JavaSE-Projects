...
public class DecisionVarInput extends BorderPane {

    private ArrayList<DecisionVar> StackOfDecisionVar;

    private final FlowPane flowPane;
    private final ComboBox<String> cmbo;

    public DecisionVarInput() {
        StackOfDecisionVar = new ArrayList();
            ...
            public void run() {
                ...
                last.getVar().setOnMouseClicked((MouseEvent e) -> {
                    if (last == StackOfDecisionVar.get(StackOfDecisionVar.size() - 1)) {
                        ...
                        StackOfDecisionVar.add(newConst);
    ...
    public ArrayList<DecisionVar> getStackOfDecisionVar() {
        return StackOfDecisionVar;
    }

    public void setStackOfDecisionVar(ArrayList<DecisionVar> StackOfDecisionVar) {
